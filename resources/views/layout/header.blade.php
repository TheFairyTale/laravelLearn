<header class="mdui-appbar mdui-appbar-fixed mdui-appbar-scroll-hide">
    <div class="mdui-toolbar mdui-color-theme">
        ...
        <div class="form-group" style="width: 50%;">
            <form>
                <div class="mdui-textfield mdui-textfield-expandable mdui-float-right">
                    <button type="button" class="mdui-textfield-icon mdui-btn mdui-btn-icon"><i class="mdui-icon material-icons">&#xe8b6;</i></button>
                    <input name="" id="" class="mdui-textfield-input" aria-label="Search here .... " aria-describedby="articleSearch" type="text" placeholder="Search" />
                    <button type="button" class="mdui-textfield-close mdui-btn mdui-btn-icon"><i class="mdui-icon material-icons">&#xe5cd;</i></button>
                </div>
            </form>
        </div>
        <!-- 用户操作菜单开始 -->
        ...
        <ul class="mdui-menu" id="userAction">
            ...
            @else
            <a href="javascript:;" class="mdui-btn mdui-btn-icon" style="margin-left: 8px;" mdui-menu="{target: '#userAction'}"><i class="mdui-icon material-icons">&#xe853;</i></a>
            <ul class="mdui-menu" id="userAction">
            ...
            <a href="javascript:;" class="mdui-btn mdui-btn-icon" mdui-menu="{target: '#systemAction'}"><i class="mdui-icon material-icons">&#xe5d4;</i></a>
            <ul class="mdui-menu" id="systemAction">
                @if ( \Auth::check() )
                @can("update", $post)

                <li class="mdui-menu-item">
                    <a href="/posts/articles/{{ $post->id }}/edit" class="mdui-ripple">Edit article</a>
                </li>
                @endcan
                <li class="mdui-menu-item">
                ...
                @endif
                <li class="mdui-menu-item">
                    <a href="javascript:;" class="mdui-ripple" onclick="changeDarkTheme(); changeHrTheme()" >Change Theme</a>
                </li>
